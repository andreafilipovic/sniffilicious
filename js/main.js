...
var dogCover=['img/dog3.jpg','img/b.jpg','img/westie.jpg'];
...
var patients=["img/cavalier.jpg","img/kokerspanijel.jpg","img/mops.jpg","img/boxer.jpg","img/canecoros.jpg","img/bulldog.jpg","img/golden.jpg","img/maltezer.jpg","img/labrador.jpg"];

for (var i = 0; i < patients.length; i++) {
    var img = document.createElement("img");
    img.setAttribute('alt',"patient");
    img.setAttribute('title',"patient"+i)
    img.setAttribute('src',patients[i])
    img.setAttribute('class',"dogs col-lg-4 col-sm-12")
   
    document.getElementById('all-patients').appendChild(img);
}
...
$(document).ready(function () {
  ...
  $(".link-patients").click(function() {
  $('html, body').animate({
    scrollTop: $("#patients-section").offset().top
  }, 2000)
});
  ...
  $('html, body').animate({
    scrollTop: $("#snifTitle").offset().top
  }, 2000)
});
